...
const NumberBox = () => {
  ...
  // useSelector의 화살표함수를 통해서 state는 modules/index.js의 전체 state에 접근
  // state.number는 modules/index.js에 연결해준 number.js의 { number }를 의미
  ...
  // dispatch를 사용해 줄 때, dispatch({ type: 값 }) 전달 - tyepe통해서 리듀서를 찾아감
